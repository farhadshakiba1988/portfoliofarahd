        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">I'M Farhad Shakiba</h1>
              <span class="text-grey">Data Engineer & Python Developer</span><br/>
      ...
      <v-col cols="12" class="mt-16" id="about">
        <div>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              <h4 class="mt-n4">I am a Senior Data Engineer and Backend Python Developer,
                tech enthusiast. I have been passionate about Data Engineering
                for over a decade.</h4>
              <h4 class=""></h4>
              <p class="text-grey">
                First as a self-taught Data Engineer and then Data Engineering team leader in a large company. When I
                realized how much need there was for training in this area, I followed my passion and started my own
...
<!--                Placeat dicta architecto reiciendis est veniam. Unde.-->
            ...
            <v-col cols="12">
              <div class="child">
                <v-btn
                    ...
                    class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Develop Data warehouse</h3>
              ...
              <div class="child">
                <v-btn
                    ...
                    class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Data Base Design</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit amet <br/>consectetur adipisicing
                  <br/>consectetur adipis
                </p>
              ...
              <div class="child">
                <v-btn
                    ...
                    class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Backend Developer</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Lorem, ipsum dolor sit amet <br/>consectetur adipisicing
                  <br/>consectetur adipis
                </p>
      ...
      <v-col cols="12" sm="12" id="services">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn class="mr-2" variant="tonal">Data Engineer</v-btn>
          <v-btn class="mr-2" variant="tonal">Backen Developer</v-btn>
          <v-btn variant="tonal"> Business Intelligence</v-btn>
        </div>
      </v-col>
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              >
              <br/>
              <span class="text-caption">Iran Tehran</span
              ><br/>
              <v-btn
              ...
              >
              <br/>
              <span class="text-caption">+989199124936</span> <br/>
              <v-btn
              ...
              >
              <br/>
              <span class="text-caption">farhadshakiba1987@gmail.com </span> <br/>
            </div>
          </v-col>
          <v-col cols="12" sm="8">
